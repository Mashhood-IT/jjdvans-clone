...
const generateBookingEmailHTML = (booking, companyData = null) => {
  ...
  const pickupTime = booking?.date && booking?.hour !== undefined
...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background-color:#f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f5f5f5;padding:15px 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="vertical-align:middle;">
                    ...
                    ${companyData?.superadminCompanyPhoneNumber || companyData?.superadminCompanyEmail ? `
    ...
    const accessField = idx === 0 ? 'dropoffAccess' : `additionalDropoff${idx}Access`;
    const floorField = idx === 0 ? 'dropoffFloorNo' : `additionalDropoff${idx}FloorNo`;
    ...
    return `
              ...
              ${booking?.notes || booking?.extraTime || booking?.durationText || booking?.distanceText ? `
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#1f2937;border-radius:6px;">
                <tr>
                  <td style="padding:20px;">
                    ${booking?.fare || booking?.additionalTimeFare || booking?.workersCharges ? `
